...
module "sagemaker" {
  ...
  sagemaker_model_execution_role_arn = "arn:aws:iam::497976830529:role/SagemakerFullAccess"
  ...
  sagemaker_notebook_instance_role_arn      = "arn:aws:iam::497976830529:role/SagemakerFullAccess"
